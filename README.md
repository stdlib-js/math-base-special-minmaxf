...
<!-- <div class="equation" align="center" data-raw-text="(m, M) = (\min(x, y),\; \max(x, y))" data-equation="eq:minmax_function">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@85f48534ef6908bbcd982d48f1c5fbea3fb7aafd/lib/node_modules/@stdlib/math/base/special/minmaxf/docs/img/equation_minmax_function.svg" alt="Minimum and maximum of two values">
    <br>
</div> -->
