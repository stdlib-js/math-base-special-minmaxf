...
<!-- <div class="equation" align="center" data-raw-text="(m, M) = (\min(x, y),\; \max(x, y))" data-equation="eq:minmax_function">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@e35241e609f4ea7a5a1e367022755bde30d3119f/lib/node_modules/@stdlib/math/base/special/minmaxf/docs/img/equation_minmax_function.svg" alt="Minimum and maximum of two values">
    <br>
</div> -->
