...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-base-special-minmaxf/tags). For example,

```javascript
minmaxf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-minmaxf@v0.1.0-umd/browser.js' )
```
